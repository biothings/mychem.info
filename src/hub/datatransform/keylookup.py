...
graph_mychem.add_node("cas", prefix="CAS")
graph_mychem.add_node("chembl", prefix="CHEMBL.COMPOUND")
graph_mychem.add_node("drugbank", prefix="DRUGBANK")
graph_mychem.add_node("drugcentral", prefix="DrugCentral")
graph_mychem.add_node("drugname")
graph_mychem.add_node("inchi", prefix="INCHI")
graph_mychem.add_node("inchikey", prefix="INCHIKEY")
graph_mychem.add_node("mesh", prefix="MESH")
graph_mychem.add_node("ndc")
graph_mychem.add_node("omop")
graph_mychem.add_node("pharmgkb", prefix="PHARMGKB.DRUG")
graph_mychem.add_node("pubchem", prefix="PUBCHEM.COMPOUND")
graph_mychem.add_node("rxnorm")
graph_mychem.add_node("smiles")
graph_mychem.add_node("umls", prefix="UMLS")
graph_mychem.add_node("unii", prefix="UNII")
...
graph_mychem.add_edge(
    "pubchem", "unii",
    object=MongoDBEdge("unii", "unii.pubchem", "unii.unii"),
    weight=4.0,
)
